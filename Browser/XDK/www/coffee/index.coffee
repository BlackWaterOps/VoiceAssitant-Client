class window.Please
	constructor: (options) ->
		@debug = true
		@debugData = { }
		@classifier = 'http://casper-v1-dot-recognant-nli.appspot.com/v1'
		@disambiguator = 'http://casper-v1-dot-recognant-nli.appspot.com/v1/disambiguate'
		@personal = 'http://stremor-pud.appspot.com/v1/'
		@responder = 'http://rez-dot-recognant-rez.appspot.com/v1/'
		@lat = 33.4930947
		@lon = -111.928558
		@mainContext = null
