...
$(function () {
    ...
    */
    ...
    function onDeviceReady() {
        ...
        actions["capture_video"]();
        // window.plugins.alarmClockPlugin.addAlarm(new Date(), "Please Alarm", false, function() {console.log("works");}, function() {console.log("does not work");});
    }
