...
(function() {
  ...
  window.Please = (function() {
    function Please(options) {
      ...
      this.debug = true;
      this.debugData = {};
      this.classifier = 'http://casper-v1-dot-recognant-nli.appspot.com/v1';
      this.disambiguator = 'http://casper-v1-dot-recognant-nli.appspot.com/v1/disambiguate';
      this.personal = 'http://stremor-pud.appspot.com/v1/';
      this.responder = 'http://rez-dot-recognant-rez.appspot.com/v1/';
      this.lat = 33.4930947;
      this.lon = -111.928558;
